    ...
    //        this.pc_VendaTableAdapter.Fill(this.dsVendas.pc_Venda);
        ...
        private void btnGravar_Click(object sender, EventArgs e)
        {
            try
            {
                if (operacao == Operacao.incluir)
                {
                    ...
                    pc_VendaTableAdapter.InsertQuery((Int32)cmbNome.SelectedValue,
                        dtpDataVenda.Value, dtpDataEntrega.Value, txtObs.Text);
        ...
        private void btnExcluirItem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dgvItemVendas.SelectedRows.Count > 0)
                {
                    ...
                    {
                        /*
                        pc_ItemVendaTableAdapter.DeleteQuerry(
                ...
                if (dgvItemVendas.RowCount > 0)
                {
                    ...
                    }else
                    {
                        ...
                        pc_ItemVendaTableAdapter.FillByDescricao(
                            this.dsVendas.pc_ItemVenda,Convert.ToInt32(
        ...
        private void btnGravarItem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if(operacao == Operacao.incluirItem)
                {
                    /*
                ...
                }else if(operacao == Operacao.editarItem)
                {
